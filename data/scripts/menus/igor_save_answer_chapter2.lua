...
function save_answers_menu:read_answers()
  ...
  if good_answer_counter_chapter2 == 1 then
...
good_answer_table = {} 
-- La table good_answer_counter_chapter2 est créée depuis la carte Kokoro
-- good_answer_counter_chapter2 = {}


for i = 1, number_of_answers do
    good_answer_table[i] = sol.language.get_string("igor_answers.chapter2_answer" .. i .. "")
end
...
-- Définition d'une table pour les réponses
  for i = 1, number_of_answers do
    ...
    and answer_table[i] ~= "Bravo, bonne réponse" then
      ...
      good_answer_counter_chapter2 = 1
