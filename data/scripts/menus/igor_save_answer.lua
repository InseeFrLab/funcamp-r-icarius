...
function save_answers_menu:read_answers()
  ...
  if good_answer_counter == 1 then
    igor_save_answer_menu = require("scripts/menus/igor_save_answer")
...
good_answer_counter = {}
for i = 1, number_of_answers do
    good_answer_table[i] = sol.language.get_string("selection_menu.answer" .. i .. "")
end
