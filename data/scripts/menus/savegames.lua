...
local function build_layout()
  ...
  layout:make_wooden_frame(32, 192, 256, 32)
  layout:make_text(sol.language.get_string("savegames_menu.explications"), 160, 200, "center")
