...
local function create_status_widget(game)
  ...
  widget:make_text(sol.language.get_string("pause.inventory.force"), 5, 44, "left")
  widget:make_text(": " .. force, 65, 44, "left")
  widget:make_text(sol.language.get_string("pause.inventory.defense"), 5, 60, "left")
  widget:make_text(": " .. defense, 65, 60, "left")
...
local function create_runes_widget(game)

  local widget = gui_designer:create(224, 48)
  widget:set_xy(16, 176 + movement_distance)
  widget:make_green_frame()
  widget:make_text(sol.language.get_string("pause.inventory.runes"), 5, 4, "left")
